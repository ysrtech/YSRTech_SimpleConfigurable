 ...
 *
 * @see YSRTech_SimpleConfigurable_Model_Catalog_Product_Type_Simple
 */
class YSRTech_SimpleConfigurable_Model_Catalog_Product_Type_Virtual extends Mage_Catalog_Model_Product_Type_Virtual
{
    /**
